    ...
    class Program
    {
        ...
        static void Game(string login, string password)
        {
            ...
            while (true)
            {
                ...
                char[] guessDig = guessNum.ToString().ToCharArray();
                ...
                (int GuessedDigits, int GuessedInPlace) result = CompareNumbers(num, guessNum);
        ...
        {
            char[] numberDig = number.ToString().ToCharArray();
            char[] guessDig = guess.ToString().ToCharArray();

            int guessedDig = 0;
            int guessedInPlace = 0;
